...
_PROVIDER_META: dict[AssetClass, ProviderMeta] = {
    ...
    AssetClass.HK_STOCK: ProviderMeta(
        name="yahoo_finance",
        source_mode="yahoo_finance_hk",
        quality_flags=("delayed_possible", "market_hours", "research_only"),
        continuous=False,
        execution_venue=False,
        realtime_supported=False,
...
_SOURCE_ALIASES = {
    ...
    "yahoo_finance_hk": "yahoo_finance_hk",
    "yahoo_hk": "yahoo_finance_hk",
...
_SOURCE_ASSET_CLASSES = {
    ...
    "yahoo_finance_hk": AssetClass.HK_STOCK,
...
_SOURCE_META = {
    ...
    "yahoo_finance_hk": _PROVIDER_META[AssetClass.HK_STOCK],
...
_SOURCE_MANIFESTS: dict[str, SourceManifest] = {
    ...
    "yahoo_finance_hk": SourceManifest(
        source_id="yahoo_finance_hk",
        ...
        symbol_timeframes={
            "0100.HK": (Timeframe.DAY,),
            "2513.HK": (Timeframe.DAY,),
            "0700.HK": (Timeframe.DAY,),
            "9988.HK": (Timeframe.DAY,),
        },
        enforce_symbol_allowlist=True,
    ),
